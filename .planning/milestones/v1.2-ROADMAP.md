...
- [x] **Phase 25: Onboarding Persistence** — Wire completed steps to Convex per-user storage so progress survives sessions (completed 2026-03-15)
...
| 25. Onboarding Persistence | 2/2 | Complete   | 2026-03-15 | - |
