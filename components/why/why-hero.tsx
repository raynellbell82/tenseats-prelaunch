    ...
    <section className="relative min-h-[calc(100dvh-5rem)] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto px-6 sm:px-8 text-center">
        ...
        >
          ...
          <span className="block text-muted-foreground/50">On purpose.</span>
        </motion.h1>
        ...
        >
          We didn&apos;t build another marketplace. We built the one that
          shouldn&apos;t need to exist — because the best food was never meant
          to be searched for.
        </motion.p>
      </div>
